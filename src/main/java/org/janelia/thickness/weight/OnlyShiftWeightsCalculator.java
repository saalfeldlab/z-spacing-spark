...
public class OnlyShiftWeightsCalculator implements WeightsCalculator
{
	...
	private final JavaPairRDD< Long, FloatProcessor > shiftWeights;

	private final int[] dims;

	public OnlyShiftWeightsCalculator( final JavaPairRDD< Long, FloatProcessor > shiftWeights, final int... dims )
	{
		super();
			...
			final int[] step )
	{
		...
		final JavaPairRDD< Long, HashMap< Tuple2< Long, Long >, Double > > weightsBySection = shiftWeights
				.mapToPair( t -> {
