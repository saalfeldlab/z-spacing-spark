...
public class OnlyShiftWeightsCalculator implements WeightsCalculator
{

	private final JavaPairRDD< Integer, FloatProcessor > shiftWeights;

	private final int[] dims;

	public OnlyShiftWeightsCalculator( final JavaPairRDD< Integer, FloatProcessor > shiftWeights, final int... dims )
	{
		super();
			...
			final int[] step )
	{
		...
		final long nSections = shiftWeights.count();

		final JavaPairRDD< Integer, HashMap< Tuple2< Integer, Integer >, Double > > weightsBySection = shiftWeights
				.mapToPair( t -> {
