...
public class ScaleOptions
{
	...
	public ScaleOptions( int[][] steps, int[][] radii, int[][] correlationBlockRadii, int[][] maxOffsets, Options[] inference, int scale, String source, String mask, String target, int start, int stop )
	{
		super();
		this.steps = steps;
		this.radii = radii;
