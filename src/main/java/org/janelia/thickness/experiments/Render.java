...
public class Render {
    ...
    {
        JavaPairRDD<K, double[]> inverted = lut
                .mapToPair(new PairFunction<Tuple2<K, double[]>, K, double[]>() {
                    @Override
...
//        String root = "/nobackup/saalfeld/hanslovskyp/CutOn4-15-2013_ImagedOn1-27-2014/export/crop/1349-3399/experiments/" + id;
        ...
        // String sourcePath = "/nobackup/saalfeld/philipp/AL-Z0613-14/analysis/registration/0-999/export/scale10/329x575x816+658+656+135";
//        String sourcePath = "/nobackup/saalfeld/philipp/AL-Z0613-14/analysis/registration/0-999/export/scale10/762x915+358+376";
...
//
            ...
            ConvertedRandomAccessibleInterval<FloatType, DoubleType> lut = new ConvertedRandomAccessibleInterval<FloatType, DoubleType>(
                    ImageJFunctions.wrapFloat(new FolderOpener().openFolder(backwardLutPath)),
                    new RealDoubleConverter<FloatType>(),
                    new DoubleType()
            );
            ...
            RealRandomAccessible<RealComposite<DoubleType>> extendedCollapsed
                    = Views.interpolate(Views.extendBorder(collapsed), new NLinearInterpolatorFactory<RealComposite<DoubleType>>());
            ...
            RealRandomAccess<FloatType> sourceRa =
                    Views.interpolate(Views.extendValue(stack, new FloatType(Float.NaN)), new NLinearInterpolatorFactory<FloatType>()).realRandomAccess();
