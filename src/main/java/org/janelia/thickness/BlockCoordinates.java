 ...
 * 
 *         Manage coordinates of blocks defined by radius and stride that are
 *         centered on integer positions of the original grid.
 * 
 */
public class BlockCoordinates implements Serializable
{
	 ...
	 * 
	 * @param other
	 *            coordinate, potentially from different block
	...
	/**
	 * 
	 * Generate coordinates from bounding box. Use {@link Generator} to specify
	 * how coordinates should be stored.
	 *
	 */
