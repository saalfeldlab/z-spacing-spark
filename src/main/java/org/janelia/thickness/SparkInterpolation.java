...
public class SparkInterpolation
{
	...
	/**
	 * 
	 * Match coordinates in new coordinate space to coordinates in old
	 * coordinate space and associate weights, e.g. {0,1} for nearest neighbor
	 * interpolation or [0,1] for bilinear interpolation.
	 * 
	 * 
	 * @author Philipp Hanslovsky &lt;hanslovskyp@janelia.hhmi.org&gt;
	 *
	 ...
	 *
	 */
	public static class SwapKey< K1, K2, V1, V2 > implements PairFunction< Tuple2< Tuple2< K1, V1 >, Tuple2< K2, V2 > >, K2, Tuple2< V1, V2 > >
	{
		/**
		 * 
		 */
	 ...
	 *            key
	 */
	public static class WeightedArrays< K > implements PairFunction< Tuple2< K, Tuple2< double[], Double > >, K, Tuple2< double[], Double > >
	{
		/**
		 * 
		 */
		...
		public Tuple2< K, Tuple2< double[], Double > > call( Tuple2< K, Tuple2< double[], Double > > t ) throws Exception
		{
			...
			double[] arr = arrWithWeight._1().clone(); // TODO clone here? YES!
														// otherwise garbage
														// output
