...
public class JoinFromList
{
	...
	/**
	 *
	 * rdd in: ( T -> U ) map M: { T -> V1 } rdd out: ( TU -> U,V1 )
	 *
	 * @param <T>
	 * @param <U>
	 * @param <V>
	...
	public static class AssociateWith< T, U, V, M extends Map< T, V > > implements PairFunction< Tuple2< T, U >, T, Tuple2< U, V > >
	{
		...
		public AssociateWith( final Broadcast< M > keysAndValues )
		{
			super();
		...
		@Override
		public Tuple2< T, Tuple2< U, V > > call( final Tuple2< T, U > t ) throws Exception
		{
			final T key = t._1();
	...
	public static class MoveToKey< K, V1, V2 > implements PairFunction< Tuple2< K, Tuple2< V1, V2 > >, Tuple2< K, V1 >, V2 >
	{
		...
		@Override
		public Tuple2< Tuple2< K, V1 >, V2 > call( final Tuple2< K, Tuple2< V1, V2 > > t ) throws Exception
		{
			final Tuple2< V1, V2 > valuePair = t._2();
	...
	public static class FlatOut< T, U, L extends Iterable< U > > implements PairFlatMapFunction< Tuple2< T, L >, T, U >
	{
		...
		class MyIterator implements Iterator< Tuple2< T, U > >
		{
			...
			public MyIterator( final Iterator< U > it, final T constant )
			{
				super();
				this.it = it;
	...
	public static class Rearrange< K1, K2, V1, V2 > implements PairFunction< Tuple2< K1, Tuple2< Tuple2< K2, V2 >, V1 > >, Tuple2< K1, K2 >, Tuple2< V1, V2 > >
	{
		...
		@Override
		public Tuple2< Tuple2< K1, K2 >, Tuple2< V1, V2 > > call( final Tuple2< K1, Tuple2< Tuple2< K2, V2 >, V1 > > t ) throws Exception
		{
