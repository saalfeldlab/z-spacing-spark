...
public class CorrelationBlocks implements Serializable
{
	...
	public Tuple2< Double, Double > translateCoordinateIntoThisBlockCoordinates( CorrelationBlocks other, Tuple2< Integer, Integer > localCoordinate )
	{
	...
	public Tuple2< Double, Double > translateCoordinateIntoThisBlockCoordinates( Coordinate other )
	{
