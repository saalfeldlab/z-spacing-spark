...
//                final double sumX  = sumsX.getDoubleSum( xMin, yMin, xMax, yMax );
//                final double sumY  = sumsY.getDoubleSum( xMin, yMin, xMax, yMax );
//                final double sumXX = sumsXX.getDoubleSum( xMin, yMin, xMax, yMax );
//                final double sumYY = sumsYY.getDoubleSum(xMin, yMin, xMax, yMax);
                ...
                double weight = (
                        ...
                        Double.NaN :
                        1.0; //Math.sqrt( n * sumXX - sumX * sumX );
                // 0.5* ( n * sumXX - sumX * sumX + n * sumYY - sumY * sumY );
                weights.setf( x, y, (float) weight );
            }
        }
