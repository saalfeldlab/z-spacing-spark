...
public class SparkInference {
    ...
    public static JavaPairRDD<Tuple2<Integer, Integer>, double[]> inferCoordinates(
            ...
            JavaPairRDD<Tuple2<Integer, Integer>, double[]> startingCoordinates,
            final Options options,
            final String pattern) {
        JavaPairRDD<Tuple2<Integer, Integer>, Tuple2<FPTuple, double[]>> matricesWithStartingCoordinates = matrices
                .join(startingCoordinates);

        System.out.flush();
        JavaPairRDD<Tuple2<Integer, Integer>, double[]> result = matricesWithStartingCoordinates
                .mapToPair(new Inference<Tuple2<Integer, Integer>>(options, pattern));
    ...
    public static class Inference<K> implements PairFunction<Tuple2<K, Tuple2<FPTuple, double[]>>, K, double[]> {
        ...
        public Tuple2<K, double[]> call(final Tuple2<K, Tuple2<FPTuple, double[]>> t)
                throws Exception {
